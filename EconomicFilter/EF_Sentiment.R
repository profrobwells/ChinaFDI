...
write.csv(TEXT_sentiment, "./EconomicFilter/EF_sentiment_score.csv")
...
write.csv(total_TEXTsentiment, "./EconomicFilter/EF_total_text_sentiment_score.csv")
...
write.csv(pub_bing_total_TEXTsent, "./EconomicFilter/EF_pub_total_text_sentiment_score.csv")
